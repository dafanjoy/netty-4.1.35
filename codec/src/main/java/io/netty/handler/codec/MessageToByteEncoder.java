 ...
 */
/**
 *  这之所以是个定义一个泛型抽象类，就是要接收我们定义消息对象，通过编码操作转化成可以发送字节流
 * @author ThinkPad
 *
 * @param <I>
 */
public abstract class MessageToByteEncoder<I> extends ChannelOutboundHandlerAdapter {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        ByteBuf buf = null;
        try {
            if (acceptOutboundMessage(msg)) {//判断msg与你定义的类型是否一致
     ...
     */
      ...
      * @param msg 这里传入的msg就是我们定义的消息实体
      * @param out 编码后把消息转为ByteBuf
      * @throws Exception
      */
    //需要重写的encode编码方法，这里传入的msg就是我们定义的消息实体
