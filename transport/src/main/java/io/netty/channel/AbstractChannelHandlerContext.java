...
abstract class AbstractChannelHandlerContext extends DefaultAttributeMap
    ...
    public ChannelHandlerContext fireChannelRead(final Object msg) {
    	//开始消息传递，findContextInbound方法按顺序当前ChannelHandlerContext的next节点
    ...
    private void invokeChannelRead(Object msg) {
        if (invokeHandler()) {
            try {
            	//获取封装的ChannelHandler，并调用我们实现的channelRead方法，
    ...
    private void invokeWriteAndFlush(Object msg, ChannelPromise promise) {
        if (invokeHandler()) { //是否调用回调方法
        	...
        	//这里需要注意以下，无论你在哪个outHandler中调用writeAndFlush，这里也必须等到所有handler的write方法执行完毕后才会flush
            invokeWrite0(msg, promise);
            invokeFlush0();
        } else {
    ...
    private void write(Object msg, boolean flush, ChannelPromise promise) {
        ...
        //寻找下一个AbstractChannelHandlerContext节点
